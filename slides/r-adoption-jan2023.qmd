...
-   an issue that has been encountered is that current repositories (GitHub, CRAN) do not require any statistical quality assurance for R packages
-   to deal with this identified issue, a group came together part of the ASA called the "Software Engineering Working Group" SWE WG to look R packages from a statistical point of view

## SWE WG - What We Want to Work on
