...
-   Write tests that you will not need to update or maintain because of a dependency.
    ...
    - Note: Having unit tests allows dependency changes to be detected earlz enough - e.g. CRAN is running reverse dependency checks before accepting new package versions
