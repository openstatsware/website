...
3.  **Clone repositories** of packages of package developers you are familiar with:
    -   Run the tests you find there.
    -   You will learn a lot about testing, coding and strategies.
4.  **Read books** to learn testing strategies.

## What can and should be unit tested?

1.  Script
  - Single files with functions can have unit tests built for them
2.  Packages
...
todo: move "no tests" to low coverage. explain before what snapshot tests are explain what bad tests are?
