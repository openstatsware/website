...
2. **Use tools that track dependencies and their versions** as these are moving targets, i.e. they are periodically updated. Insufficient dependency management is a common reason for "it doesn't work on my computer" errors. 
